...
class FoodAdapter(val list: ArrayList<RegisterResponse.foodListResponse>, val activity: FragmentActivity?) : RecyclerView.Adapter<FoodAdapter.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.food_list_item, parent, false))
    }
